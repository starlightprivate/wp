...
function shapely_footer_info() {
  printf( esc_html__( 'Copyright Tactical Mastery © 2016 All Rights Reserved', 'shapely' ) , '<a href="https://colorlib.com/" target="_blank" title="Colorlib">Colorlib</a>', '<a href="http://wordpress.org/" target="_blank" title="WordPress.org">WordPress</a>');
}
